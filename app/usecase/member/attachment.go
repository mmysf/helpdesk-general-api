...
func (u *appUsecase) UploadAttachment(ctx context.Context, claim domain.JWTClaimUser, payload domain.UploadAttachment, request *http.Request) response.Base {
...
func (u *appUsecase) GetAttachmentDetail(ctx context.Context, claim domain.JWTClaimUser, attachmentId string) response.Base {
	ctx, cancel := context.WithTimeout(ctx, u.contextTimeout)
	defer cancel()
